...
function MilestoneImageSlider({ images, singleImage, title, isActive, date, category, IconComponent }) {
 ...
 <div className="absolute inset-0 /85 /20 /30 pointer-events-none z-10" />
 ...
 currentIndex === idx
 ? 'w-5 bg-blue-600 shadow-[0_0_8px_#3b82f6]'
...
function MilestoneRow({ item, index, isEven }) {
 ...
 >
 {isActive && (
 <div className="w-2.5 h-2.5 rounded-full bg-blue-600 animate-pulse shadow-[0_0_8px_#38bdf8]" />
 )}
 </div>
 </div>
 ...
 >
 {isActive && (
 <div className="w-2 h-2 rounded-full bg-blue-600 animate-pulse shadow-[0_0_6px_#38bdf8]" />
 )}
 </div>
 </div>
...
export default function DeveloperJournal() {
 ...
 <div className="absolute bottom-1/4 left-0 w-[600px] h-[600px] bg-blue-600/10 blur-[160px] rounded-full pointer-events-none" />
 ...
 aria-hidden="true"
 className="absolute left-1/2 -translate-x-1/2 top-4 bottom-4 w-[3px] shadow-[0_0_18px_#38bdf8] pointer-events-none hidden md:block origin-top"
 />
 ...
 style={{ scaleY, originY: 0 }}
 aria-hidden="true"
 className="absolute left-4 sm:left-6 top-4 bottom-4 w-[3px] shadow-[0_0_16px_#38bdf8] pointer-events-none md:hidden origin-top"
 />
