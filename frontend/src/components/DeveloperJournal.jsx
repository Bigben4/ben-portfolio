...
import { Calendar, BookOpen, Trophy, Rocket, Users, Code2, Sparkles } from 'lucide-react'
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 space-y-3">
          ...
          <p className="text-slate-400 text-sm sm:text-base">
            Timeline of recent hackathons, community technical workshops, and major production release achievements.
          </p>
        </div>
              ...
              return (
                ...
                >
                  ...
                  <div className="w-full md:w-1/2 md:px-8">
                    <div className="rounded-2xl border border-slate-800 bg-slate-950/80 p-6 shadow-xl hover:border-sky-500/40 transition-all duration-300 space-y-3 group">
