...
export default function ContactSection() {
 ...
 {copiedEmail ? (
 <>
 <Check className="w-5 h-5 md:w-6 md:h-6 shrink-0 text-blue-600" />
 <span className="text-blue-600">Copied Email!</span>
 </>
 ) : (
 <>
 ...
 className="min-h-[48px] w-full sm:w-auto inline-flex items-center justify-center gap-1.5 px-4 py-2 rounded-lg bg-emerald-500/10 text-blue-600 border border-blue-600 text-xs font-semibold hover:bg-emerald-500 hover:text-blue-600 transition-all"
 >
 ...
 {status === 'success' && (
 <div className="flex items-center gap-3 p-4 rounded-xl bg-emerald-500/10 border border-blue-600 text-blue-600 text-xs">
 ...
 className="w-full min-h-[48px] inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-xl font-bold text-xs text-white bg-blue-600 hover:bg-blue-600 shadow-lg shadow-sky-500/20 transition-all disabled:opacity-50 cursor-pointer"
 >
 {status === 'submitting' ? (
