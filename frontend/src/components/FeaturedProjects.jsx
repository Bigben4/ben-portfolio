...
export default function FeaturedProjects() {
 return (
 <section id="projects" className="py-24 border-b border-gray-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 relative overflow-hidden">
 ...
 <div className="absolute inset-0 bg-white dark:bg-zinc-950 [background-size:24px_24px] pointer-events-none opacity-30" />
